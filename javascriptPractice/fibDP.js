...
let callCount = 0;
console.log(
  `fibRecursive(${10}) = ${fibRecursive(10)}, call count: ${callCount}`
);

callCount = 0;
console.log(
  `fibRecursive(${12}) = ${fibRecursive(12)}, call count: ${callCount}`
);
...
callCount = 0;
console.log(
  `fibMemoized(${10}) = ${fibMemoized(10)}, call count: ${callCount}`
);

callCount = 0;
console.log(
  `fibMemoized(${12}) = ${fibMemoized(12)}, call count: ${callCount}`
);
