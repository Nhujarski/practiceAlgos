...
Assume you are given a Node class with a children member variable that contains all neighbors.
*/
class Test {
...
//   return hasPath(node, target)
// }

// BFS as a standalone function
// function bfsHasPathTo(node, target) {
//   if (!node)
//     return false
...
//     let curr = nodes.shift() // take from the front
